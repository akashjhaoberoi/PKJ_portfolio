            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-teal-400 font-medium block">
                  {profile.professionalTitle || 'Accountant | M.COM Accounting & Finance'}
                </span>
              </div>
            </div>
            <p className="text-xs text-slate-300/80 max-w-md leading-relaxed">
              Accounting professional with 14+ years across India, especially in Surat and Ahmedabad, specializing in financial reporting, bookkeeping, reconciliations, month-end closing, ERP systems, and GST / ITR compliance.
            </p>
