...
const PROFESSIONAL_AREAS: ProfessionalArea[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'GST/ITR-related accounting and compliance',
    ],
  },
  {
    id: 'area-4',
...
export function About({ profile }: AboutProps) {
  ...
  const introText =
    profile.summary ||
    'Accounting professional with 14+ years of experience across India, especially in Surat and Ahmedabad, specializing in financial accounting, reporting, AP & AR, reconciliations, month-end closing, inventory costing, GST/ITR compliance, and ERP-based accounting operations.';
        ...
        <div className="p-6 sm:p-7 rounded-2xl bg-[#F4F6F8] dark:bg-slate-800/40 border border-slate-200 dark:border-slate-800 shadow-xs">
          ...
          <div className="pt-4 mt-4 border-t border-slate-200/80 dark:border-slate-700/60 flex flex-wrap items-center justify-between gap-3 text-xs font-semibold text-[#64748B] dark:text-slate-400">
            <div className="flex items-center gap-2">
              ...
              <span>Operating with full compliance in Surat, Gujarat, India</span>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-3">
            ...
            {PROFESSIONAL_AREAS.map((area) => {
              ...
              return (
                <div
                  key={area.id}
                  className={`rounded-xl border transition-all duration-200 overflow-hidden bg-white dark:bg-slate-800/60 ${
                    isExpanded
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="p-3.5 rounded-xl bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800 shadow-2xs text-center">
                <span className="block text-2xl font-extrabold text-[#0F2747] dark:text-slate-100">M.COM</span>
                <span className="text-[11px] font-semibold text-slate-600 dark:text-slate-300">Finance</span>
              </div>
              <div className="p-3.5 rounded-xl bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800 shadow-2xs text-center">
                <span className="block text-2xl font-extrabold text-[#0F766E] dark:text-teal-400">GST/ITR</span>
                <span className="text-[11px] font-semibold text-slate-600 dark:text-slate-300">GST & ITR</span>
              </div>
            </div>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#0F2747]/95 via-[#0F2747]/40 to-transparent flex items-end p-4 sm:p-5">
                <div className="text-white">
                  ...
                  <p className="text-xs font-semibold text-slate-100 mt-1.5">
                    Financial Reporting, Reconciliation & GST/ITR Statutory Compliance
                  </p>
                </div>
              </div>
            </div>
