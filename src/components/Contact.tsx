...
export function Contact({ profile, onSendMessage }: ContactProps) {
  ...
  const handleOpenEmailClient = () => {
    const subject = encodeURIComponent(formData.subject || 'Professional Inquiry - Prakash Kumar Jha');
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-12">
          ...
          <p className="mt-2 text-sm text-[#64748B] dark:text-slate-400">
            Available for professional accounting, finance management, and corporate opportunities across India, especially in Surat and Ahmedabad.
          </p>
        </div>
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="p-5 rounded-2xl bg-[#F4F6F8] dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 flex items-start gap-4">
              ...
              <div>
                ...
                <span className="text-xs text-[#64748B] dark:text-slate-400 block mt-0.5">
                  Gujarat, Republic Of India (Bharat)
                </span>
              </div>
            </div>
            ...
            {profile.drivingLicense && (
              <div className="p-5 rounded-2xl bg-[#F4F6F8] dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 flex items-start gap-4">
                ...
                <div>
                  ...
                  <span className="text-xs text-[#64748B] dark:text-slate-400 block mt-0.5">
                    Authorized in Republic Of India (Bharat)
                  </span>
                </div>
              </div>
            )}
