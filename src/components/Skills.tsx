...
const PRACTICAL_SKILLS: PracticalSkillItem[] = [
  ...
  { name: 'Empire ERP', category: 'Enterprise ERP System', icon: Database, badge: 'ERP' },
  { name: 'Tamanna', category: 'Accounting & Invoicing', icon: Receipt, badge: 'Software' },
  { name: 'Tally Prime', category: 'Cloud Accounting & ERP', icon: Server, badge: 'ERP' },
  { name: 'Tripta ERP', category: 'Financial Management Software', icon: Landmark, badge: 'System' },
  ...
  { name: 'GST / ITR', category: 'Indian Tax & E-Filing', icon: ShieldCheck, badge: 'Compliance' },
