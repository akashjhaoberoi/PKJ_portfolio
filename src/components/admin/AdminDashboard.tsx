...
export function AdminDashboard({
  ...
  const handleExport = () => {
    ...
    link.href = url;
    link.download = `prakash-kumar-jha-profile-backup-${new Date().toISOString().slice(0, 10)}.json`;
    link.click();
      ...
      <div className={innerCard}>
        ...
        <div className="flex overflow-x-auto border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 scrollbar-none">
          {[
            ...
            { id: 'expertise', label: `Core Expertise (${localData.expertise.length})`, icon: Layers },
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Valid Indian Driving License"
                    onChange={(e) =>
                      setLocalData({
                        ...localData,
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Manage software tool cards (Empire, Tamanna, Tally Prime, Tripta ERP, Excel, Office).
                  </p>
                </div>
              </div>
          ...
          {activeTab === 'education' && (
            <div className="space-y-6 max-w-2xl">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  M.COM & B.COM degrees. (Institutions remain blank unless you choose to specify them).
                </p>
              </div>
              ...
              <div className="p-5 rounded-xl bg-rose-50/50 dark:bg-rose-950/20 border border-rose-200 dark:border-rose-900/50 flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-[11px] text-rose-700 dark:text-rose-300 mt-0.5">
                    Restores the original authentic CV details of Prakash Kumar Jha provided in the specification.
                  </p>
                </div>
                <button
                ...
                <div className="fixed inset-0 z-60 bg-black/60 flex items-center justify-center p-4">
                  <div className="max-w-md w-full bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl space-y-4">
                    ...
                    <p className="text-xs text-slate-600 dark:text-slate-300">
                      This will reset all edits, customized experience notes, and photo uploads back to Prakash Kumar Jha's pristine default CV information. Are you sure you want to proceed?
                    </p>
